    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-black tracking-tight text-black sm:text-6xl">Vignette Bloom<span className="text-[#147f76]">.</span></h1>
      ...
      <div className="relative aspect-[16/9] overflow-hidden rounded-3xl border-2 border-black bg-[#080d17] shadow-[8px_8px_0_#191717]">
        <AsciiCanvas params={DEFAULT_ASCII_PARAMS} />
      </div>
